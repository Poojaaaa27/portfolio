...
import { Award, Briefcase, Calendar, Trophy, Code } from 'lucide-react';
...
const workExperience = [
    {
        ...
        description: "Processed and digitized 2,000+ site images using OCR and image classification models to extract structural details, increasing data accuracy by 35%. Scraped and organized over 10,000+ construction records from internal databases and vendor websites thereby reducing manual lookup time by 60%. Collaborated with cross-functional teams to integrate digital insights into ongoing civil and structural project workflows."
    }
];
            ...
            {workExperience.map((exp, index) => (
              <Card key={index} className="glassmorphism">
                <div className="p-6 md:p-8">
                    <CardHeader className="p-0 flex-row items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-accent">{exp.role} &bull; {exp.duration}</p>
                        </div>
                    </CardHeader>
